...
@media (max-width: 640px) // index.astro @media (max-width: 600px) // project.astro @media screen and (max-width: 720px); // PortfolioPreview
```
...
<!-- Add ARIA labels -->
<a
  href="https://github.com/afilazzola"
  aria-label="Alessandro Filazzola on GitHub"
>
  <svg>...</svg>
</a>
```
